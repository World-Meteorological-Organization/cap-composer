"""
Django settings for cap_composer project.
...
from cap_composer import VERSION
from cap_composer.config.telemetry.utils import otel_is_enabled
...
if otel_is_enabled():
    MIDDLEWARE += ["cap_composer.config.telemetry.middleware.OTELMiddleware"]

ROOT_URLCONF = "cap_composer.config.urls"
...
WSGI_APPLICATION = "cap_composer.config.wsgi.application"
ASGI_APPLICATION = "cap_composer.config.asgi.application"

# Database
# https://docs.djangoproject.com/en/5.0/ref/settings/#databases

DB_ENGINE = 'cap_composer.config.db_engine'
...
STORAGES = {
    ...
    "staticfiles": {
        "BACKEND": "cap_composer.config.storage.ManifestStaticFilesStorageNotStrict",
    },
}
...
ADMIN_URL_PATH = env.str("ADMIN_URL_PATH", "cap_composer-admin")
DJANGO_ADMIN_URL_PATH = env.str("DJANGO_ADMIN_URL_PATH", default="cap_composer-django-admin")
...
CELERY_SINGLETON_BACKEND_CLASS = (
    "cap_composer.config.celery_singleton_backend.RedisBackendForSingleton"
)
...
CELERY_APP = "cap_composer.config.celery:app"
...
CACHES = {
    "default": {
        ...
        "KEY_PREFIX": "cap_composer-default-cache",
        "VERSION": VERSION,
